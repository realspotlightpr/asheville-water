    ...
    <section className="relative overflow-hidden bg-white py-20 sm:py-24">
      ...
      <div className="relative mx-auto grid max-w-6xl gap-12 px-4 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-16">
        ...
        <div className="pt-8 lg:pt-0">
          ...
          <h2 className="mt-3 font-heading text-3xl font-extrabold text-navy sm:text-4xl lg:text-5xl">
            Doug &amp; Makenna
          </h2>
          ...
          <div className="mt-7 space-y-6 font-body text-[15px] leading-7 text-ink/70">
            <div className="rounded-2xl border border-mist bg-slate-50/80 p-5 sm:p-6">
              <h3 className="font-heading text-base font-bold text-navy">Doug</h3>
              <p className="mt-2">
            ...
            <div className="rounded-2xl border border-mist bg-slate-50/80 p-5 sm:p-6">
              <h3 className="font-heading text-base font-bold text-navy">Makenna</h3>
              <p className="mt-2">
